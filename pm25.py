...
schema = {
    ...
    "list_of_col": [
        ...
        },
        {
            "name": "pm25",
            "data_type": "float",
            "desc_th": "ฝุ่นละอองที่มีขนาดเล็กกว่า 25",
            "desc_en": "Particulate Matters 25"
        }
    ]
}


file_list = os.listdir("PM25")
for file_name in file_list:
    if file_name.endswith(".xlsx"):
        file_name = f"PM10/{file_name}"
        df = pd.read_excel(file_name, sheet_name='PM2.5')
        ...
        df_result.columns = ['report_dt', 'station_code', 'pm25']
